...
public interface GoalInvitationFilter {
    ...
    boolean booleanGoalInvitation(GoalInvitationDto goalInvitationDto);

    Stream<GoalInvitation> filterGoalInvitations(Stream<GoalInvitationDto> goalInvitationDtoStream);
}
